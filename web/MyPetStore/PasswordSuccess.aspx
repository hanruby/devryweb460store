<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="PasswordSuccess.aspx.cs" Inherits="PasswordSuccess" Title="Untitled Page" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="mainContentPH" Runat="Server">
    ...
    <p>Now Redirecting you to the homepage.</p>
</asp:Content>
